          ...
          <div className="w-full max-w-2xl rounded-2xl p-6 mx-4 max-h-[90vh] overflow-y-auto"
            ...
            <div className="space-y-3">
              ...
              <textarea placeholder="Description" value={form.description}
                ...
                style={{ border: '1px solid #e5e5e5', color: '#1A1A1A' }} />
              <input placeholder="Sort Order (1=first, 2=second...)" type="number" value={form.sort_order || ''}
                onChange={e => setForm({ ...form, sort_order: e.target.value })}
                className="w-full border rounded-xl px-4 py-3 text-sm outline-none mb-3" style={{ borderColor: '#E8E8E8' }} />
